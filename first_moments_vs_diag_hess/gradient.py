...
OPTIMIZER, OPTIM_KWARGS = optim.SGD, dict(lr=1e-3)
...
assets, out = train_gd(
    ...
    tracker_fns=(compute_gradient, partial(compute_hess_diag, hutchinson_samples=HUTCHINSON_SAMPLES))
)
...
plot(grads, hess_diags, ckpts, LOG_EVERY, xlabel, ylabel, save_fn=f"{OPTIMIZER.__name__.lower()}/gradient.png")