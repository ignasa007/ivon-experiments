...
assets, out = train_gd(
    Dataset=torchvision.datasets.CIFAR10, output_dim=OUTPUT_DIM, subset_size=SUBSET_SIZE,
...
plot(grads, hess_diags, ckpts, LOG_EVERY, xlabel, ylabel, save_fn=f"{OPTIMIZER.__name__.lower()}/expavgsq-cifar10.png")