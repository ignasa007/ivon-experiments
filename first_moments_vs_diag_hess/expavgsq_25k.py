...
assets, out = train_gd(
    Dataset=torchvision.datasets.MNIST, output_dim=OUTPUT_DIM, subset_size=5*SUBSET_SIZE,
...
plot(grads, hess_diags, ckpts, LOG_EVERY, xlabel, ylabel, save_fn=f"{OPTIMIZER.__name__.lower()}/expavgsq-25k.png")